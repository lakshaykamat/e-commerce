...
const Navbar = () => {
  ...
  {showDropDown && <Dropdown setDropDown={setDropDown}/>}
</nav>

  )
}

const Dropdown = ({setDropDown}:{setDropDown:  Dispatch<SetStateAction<boolean>>})=>{
    return(
        <div
        id="mega-menu-full-dropdown"
        onBlur={()=>setDropDown(false)}
        className="mt-1 z-20  border-gray-200 shadow-sm bg-gray-50 md:bg-white border-y "
      >
